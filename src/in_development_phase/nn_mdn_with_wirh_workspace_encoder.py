...
import sys
sys.path.append('/home/antonio/LangPathModel/src/')
from textEncoders import TextEncoder
from mdn import MDN, CategoricalNetwork
sys.path.append('/home/antonio/ws/dgcnn/pytorch')
from dgcnn_wrapper import DGCNNWrapper
...
class LangPathModel(nn.Module):
	def __init__(self, 
		...
		self.mesh_model = DGCNNWrapper()
		self.mesh_layer = nn.Linear(d_model)
